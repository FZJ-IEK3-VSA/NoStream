...
with st.sidebar:
    ...
    st.markdown("💻 [Quellcode der Optimierung anzeigen](https://github.com/ToniGustavson/eu_energy_independence/blob/3a5a78ca33caec7777fb3b04afea66a423182335/storage_sim.py)")
