...
def plot_import_gap(
    ...
    fig.add_trace(
        go.Bar(
            ...
            y=yvals,
            legendgroup="Embargo",
            legendgrouptitle_text="Embargo",  # ({omitted} TWh/a)",
            name="LNG Import RU",
    ...
    fig.add_trace(
        go.Bar(
            ...
            # legendgroup="Importerhöhung",
            # legendgrouptitle_text="Importerhöhung",
            name="LNG Import (zus.)",
...
def plot_status_quo(font_dict=None, streamlit_object=None):
    fig = go.Figure()
...
def plot_optimization_results(df, legend_dict=None, font_dict=None):
    df_og = df.copy()
